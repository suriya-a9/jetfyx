...
const features = [
    {
        ...
        desc: "High-performance trading engine for smooth execution of trades with advanced charting and analysis tools.",
        image: "/assets/feature/Trading Platform.webp",
        icon: "/assets/feature/Trading Platform-icon.webp",
    },
    {
        title: "Liquidity Aggregator",
        desc: "Connect to multiple liquidity providers, ensuring the best prices and optimal trading conditions for your clients.",
        image: "/assets/feature/Liquidity Aggregator.webp",
        icon: "/assets/feature/Liquidity Aggregator-icon.webp",
    },
    {
        title: "CRM Systems",
        desc: "Streamline client onboarding, KYC/AML processes, and customer communication with integrated CRM solutions.",
        image: "/assets/feature/CRM Systems.webp",
        icon: "/assets/feature/CRM Systems-icon.webp",
    },
    {
        title: "Back Office Systems",
        desc: "Manage client accounts, balance updates, and margin tracking efficiently with comprehensive back office tools.",
        image: "/assets/feature/Back Office Systems.webp",
        icon: "/assets/feature/margin tracking efficiently-icon.webp",
    },
    {
        title: "Risk Management",
        desc: "Real-time risk monitoring and A/B book management for enhanced protection and compliance oversight.",
        image: "/assets/feature/Risk Management.webp",
        icon: "/assets/feature/Risk Management-icon.webp",
    },
    {
        title: "Bridge Software",
        desc: "Effortless integration with liquidity providers for optimal trading conditions and seamless connectivity.",
        image: "/assets/feature/Bridge Software.webp",
        icon: "/assets/feature/seamless connectivity-icon.webp",
    },
    {
        title: "Compliance & Security",
        desc: "Robust measures to meet regulatory requirements and safeguard client data with enterprise-grade security.",
        image: "/assets/feature/Compliance & Security.webp",
        icon: "/assets/feature/Compliance & Security-icon.webp",
    },
    {
        title: "Payments & Wallet Systems",
        desc: "Seamlessly handle payment processing and client wallets with multiple payment gateway integrations.",
        image: "/assets/feature/Payments & Wallet Systems.webp",
        icon: "/assets/feature/Payments & Wallet Systems-icon.webp",
    },
    {
        title: "Marketing & Analytics",
        desc: "Powerful tools to track affiliates, monitor performance, and improve marketing ROI with detailed analytics.",
        image: "/assets/feature/Marketing & Analytics.webp",
        icon: "/assets/feature/Marketing & Analytics-icon.webp",
    },
];
