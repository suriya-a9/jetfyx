export default function TermsModal({ open, onAgree }) {
    if (!open) return null;
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-[99999]">
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-2xl w-full relative max-h-[90vh] overflow-y-hidden">
                <h2 className="text-xl font-bold mb-4">
                    JetFyX Website Terms of Use and Usage Policy
                    <br />
                    <span className="text-sm text-gray-500 font-medium">Last Updated: 10/30/2025</span>
                </h2>
                <div className="mb-6 max-h-[60vh] overflow-y-auto text-sm text-gray-700 space-y-3 text-justify">
                    <p>
                        ...
                        These Terms of Use and Usage Policy (“Terms”) govern your access to and use of our website.{" "}
                        <a href="https://jetfyx.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">
                            https://jetfyx.com
                        </a>{" "}
                    ...
                    <p>
                        ...
                        <a href="mailto:support@jetfyx.com" className="text-blue-600 underline">
                            support@jetfyx.com
                        </a>
                    </p>
